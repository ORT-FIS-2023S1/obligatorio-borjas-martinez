...
function createHtmlMenuSemanal(menuSemanal) {
  ...
  <button type="button" class="btn bg-primary-light" data-bs-toggle="modal" data-bs-target="#addBtn">
  ...
  <!-- Modal -->
  <div class="modal fade" id="addBtn" tabindex="-1" aria-labelledby="addBtnLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         <form>
            <div class="mb-3">
              <label for="dia-agregar" class="form-label">Dia de la semana</label>
              <select class="form-select" aria-label="Default select example" id="dia-agregar">
              ...
              <select class="form-select" aria-label="Default select example" id="tipo-agregar">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn bg-primary-light" data-bs-dismiss="modal" id="btn-agregar-plato">Guardar Cambios</button>
        </div>
      </div>
    </div>
  </div>
    ...
    for (let j = 0; j < menuPlatos.length; j++) {
      html += `<div class="card mb-3">
            ...
            <div class="col-md-8">
              <div class="card-body">
                ...
                <div class="d-flex>
                  ...
                  <button type="button" class="btn bg-primary-light me-2" data-bs-toggle="modal" data-bs-target="#editBtn-${menuDay}-${j}" data-dia="${menuDay}" data-indice="${j}">
                    <span class="primary-color icon-section">
        ...
        j
                        ...
                        <div class="modal-footer">
                          <button type="button" class="btn btn-dark" data-bs-dismiss="modal">Cerrar</button>
                          <button type="button" class="btn bg-primary-light" data-bs-dismiss="modal" id="btn-save-menu-${menuDay}-${j}" data-indice="${j}" data-dia="${menuDay}" data-titulo="${menuPlatos[j].getTitulo()}">Guardar Cambios</button>
                          </div>
                      </div>
                    </div>
                  </div>
